...
class _ReferralPageState extends State<ReferralPage> {
  ...
  void _shareReferralCode() {
    if (_referralCode != "Not Assigned" && _referralCode != "Loading...") {
      final String message = "${context.loc.joinAppMessage}: $_referralCode.\n"
                                  ...
                                  Text.rich(
                                    TextSpan(
                                      ...
                                      children: [
                                        TextSpan(
                                          text:
                                              "$_rewardPoints ${context.loc.points}",
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            color: Colors.green,
                                          ),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 8),
                                  _buildStep(
                                      context.loc.shareReferralWithFriends,
                                      isDarkMode,
                                      fontSize),
                                  _buildStep(context.loc.friendSignsUp,
                                      isDarkMode, fontSize),
                                  _buildStep(context.loc.bothEarnRewards,
                                      isDarkMode, fontSize),
                                ],
                              ),
                            ),
